...
public class Register extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameR.setBackgroundColor(Color.WHITE);
        surnameR=(EditText)findViewById(R.id.surnameR);
        surnameR.setBackgroundColor(Color.WHITE);
        passwordR=(EditText)findViewById(R.id.passwordR);
        passwordR.setBackgroundColor(Color.WHITE);
        numberR=(EditText)findViewById(R.id.brojMob);
        numberR.setBackgroundColor(Color.WHITE);
        emailR=(EditText)findViewById(R.id.emailR);
        emailR.setBackgroundColor(Color.WHITE);
    ...
    public void onClick(View v) {
                        ...
                        if (!name.isEmpty() && !password.isEmpty() && !surname.isEmpty() && !kontakt_broj.isEmpty()) {
                                ...
                                handler.post(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        data[3] = kontakt_broj;
                                        data[4] = "username";
                                        PutData putData = new PutData("http://192.168.1.7/LoginRegister/signupDoktor.php", "POST", field, data);
                                        if (putData.startPut()) {
        ...
        try {
            ...
            fos.write("\n".getBytes());
            fos.write(emailR.getText().toString().getBytes());
            fos.write("\n".getBytes());
            fos.write(numberR.getText().toString().getBytes());
            fos.write("\n".getBytes());
